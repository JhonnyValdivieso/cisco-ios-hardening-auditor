...
def audit_conf(lines):
   ...
   # --- STRUCTURING THE RESULTS (BUSINESS RULES) ---
    results = []
    ...
    results.append({
        "id": "RULE-02",
        "name": "Secure Shell Enforce [Telnet]",
    ...
    # Rule 6: Privilege Escalation Security (Enable Password vs Secret)
    ...
    # Rule 7: SNMP Community String Security
    ...
    # Rule 8: VTY Line Authentication
    results.append({
        "id": "RULE-08",
    ...
    # Rule 9: Time Synchronization (NTP)
    results.append({
        "id": "RULE-09",
    ...
    # Rule 10: Web Management Security (HTTP vs HTTPS)
